package com.liangmayong.base.widget.pullrefresh;
...
import com.liangmayong.base.widget.pullrefresh.drawables.DefualtDrawable;
import com.liangmayong.base.widget.pullrefresh.drawables.RefreshDrawable;
...
public class PullRefreshLayout extends ViewGroup {
    ...
    public PullRefreshLayout(Context context, AttributeSet attrs) {
        ...
        int[] colors = new int[]{0xffCD6090, 0xff8B2323, 0xff218868, 0xff00688B};
        mRefreshView = new ImageView(context);
        setRefreshDrawable(new DefualtDrawable(this, colors));
