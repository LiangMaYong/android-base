 ...
 */
public class DefualtDrawable extends RefreshDrawable implements Animatable {
    ...
    public DefualtDrawable(PullRefreshLayout parent, int... colors) {
        super(parent);
        mParent = parent;
...
//        ViewCompat.setLayerType(this, ViewCompat.LAYER_TYPE_SOFTWARE, circle.getPaint());
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int x = DefualtDrawable.this.getBounds().centerX();
            final int y = DefualtDrawable.this.getBounds().centerY();
