...
public class BadgeView extends TextView {
     ...
     * @param dip dip
     */
    public void setWidthDip(int dip) {
        super.setWidth(dip2Px(dip));
    }
     ...
     * @param dip dip
     */
    public void setHeightDip(int dip) {
        super.setHeight(dip2Px(dip));
    }
     ...
     */
    public void attachTargetView(TabWidget target, int tabIndex) {
        View tabView = target.getChildTabViewAt(tabIndex);
        attachTargetView(tabView);
    }
     ...
     */
    public void attachTargetView(View target) {
        if (getParent() != null) {
