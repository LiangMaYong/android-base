...
public abstract class DataTable {
    ...
    //mSQLiteHelper
    private DataTable.SQLiteHelper mSQLiteHelper;
    //mDataHandler
    ...
    public DataTable(final Context context, String tableName, String databaseName, int version) {
        this.mSQLiteHelper = new DataTable.SQLiteHelper(context, databaseName, version) {
            @Override
    ...
    private final String generateCreateSQL() {
        ...
        content += "timestamp " + DataType.INTEGER().name() + " NOT NULL,";
