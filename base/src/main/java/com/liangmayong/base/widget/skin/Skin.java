...
public class Skin {
    ...
    private static Application getApplication() {
        if (application == null || application.get() == null) {
            synchronized (com.liangmayong.base.widget.skin.Skin.class) {
                if (application == null) {
                    try {
    ...
    private void resetColorValue() {
        ...
        getDataPreferences().setInt("grayColor", grayColor)
                ...
                .setInt("successColor", successColor)
                .setInt("infoColor", infoColor)
                .setInt("warningColor", warningColor)
                .setInt("dangerColor", dangerColor)
                .setInt("themeTextColor", themeTextColor)
                .setInt("primaryTextColor", primaryTextColor)
                .setInt("successTextColor", successTextColor)
                .setInt("infoTextColor", infoTextColor)
                .setInt("warningTextColor", warningTextColor)
                .setInt("dangerTextColor", dangerTextColor);
    }
