...
class NetHandlerPost {
    ...
    private static class PostRequest {
        private OnNetHttpListener netListener;
        private byte[] data;
        private Exception ex;
        private String encode = "utf-8";
        private String cookie;
        private Map<String, NetFile> files = new HashMap<String, NetFile>();
        ...
        public void setFiles(Map<String, NetFile> files) {
            for (Map.Entry<String, NetFile> entry : this.files.entrySet()) {
                this.files.remove(entry.getKey());
            }
            if (files == null) {
                return;
            }
            for (Map.Entry<String, NetFile> entry : files.entrySet()) {
                this.files.put(entry.getKey(), entry.getValue());
            }
        }

        public PostRequest(OnNetHttpListener netListener) {
            ...
            try {
                if ((getParams() != null && getParams().size() > 0)
                    ...
                    if (getFiles() != null && getFiles().size() > 0) {
                        for (Map.Entry<String, NetFile> entry : getFiles().entrySet()) {
        ...
        public void Error() {
            if (netListener != null) {
                try {
                    netListener.error(new NetError(ex));
                } catch (Exception e) {
                }
            }
        }
     ...
     */
    public static void post(final String url, Map<String, String> params, Map<String, NetFile> files,
                            Map<String, String> headers, OnNetHttpListener netListener) {
     ...
     */
    public static void post(final String url, Map<String, String> params, Map<String, NetFile> files,
                            Map<String, String> headers, String encode, OnNetHttpListener netListener) {
        final PostRequest postMsg = new PostRequest(netListener);
     ...
     */
    public static void post(final String url, Map<String, String> params, Map<String, NetFile> files,
                            Map<String, String> headers, String encode, String cookie, OnNetHttpListener netListener) {
        final PostRequest postMsg = new PostRequest(netListener);
    ...
    private static void dopost(final String url, PostRequest request) {
        ...
        try {
            ...
            if (code == 200) {
                ...
                request.setException(new NetServiceError(code));
            }
        } catch (Exception e) {
