 ...
 */
class RetryLayout extends FrameLayout {
    ...
    private static final String TAG = RetryLayout.class.getSimpleName();


    public RetryLayout(Context context, AttributeSet attrs, int defStyleAttr) {
