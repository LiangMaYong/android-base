...
public class Instrumentation {
    ...
    public ActivityResult execStartActivity(final Context who, final IBinder contextThread, final IBinder token,
                                            final Activity target, final Intent intent, final int requestCode, final Bundle options) {
        return null;
    }
    ...
    public ActivityResult execStartActivity(final Context who, final IBinder contextThread, final IBinder token,
                                            final Fragment fragment, final Intent intent, final int requestCode, final Bundle options) {
        return null;
    }
