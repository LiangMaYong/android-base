...
import com.liangmayong.base.support.nethttp.NetError;
import com.liangmayong.base.support.nethttp.NetHttp;
import com.liangmayong.base.support.nethttp.OnNetHttpListener;
...
public class AudioLoader {
    ...
    public static void load(final String url, final long size, final OnAudioLoadListener loadListener) {
        NetHttp.get(url, new OnNetHttpListener() {
            @Override
