 ...
 */
public class AnyRetryLayout extends FrameLayout {
    ...
    private static final String TAG = AnyRetryLayout.class.getSimpleName();


    public AnyRetryLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mInflater = LayoutInflater.from(context);
    }


    public AnyRetryLayout(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public AnyRetryLayout(Context context) {
        this(context, null);
    }
