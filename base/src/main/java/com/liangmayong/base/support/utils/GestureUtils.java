...
public final class GestureUtils {
     ...
     * @param gestureListener gestureListener
     * @return GestureDetector
     */
    public static GestureDetector getGestureDetector(Context context, final OnGestureListener gestureListener) {
        return new GestureExt(context, new GestureExt.OnGestureResult() {
            @Override
            public void onGestureResult(int direction) {
                if (gestureListener != null) {
                    gestureListener.onTouch(new GestureType(direction), direction);
                }
            }
        }).Buile();
    }
    ...
    public static class GestureType {
         ...
         */
        public GestureType(int direction) {
            Type = direction;
        }
    ...
    public interface OnGestureListener {
        void onTouch(GestureType gestureType, int direction);
    }
     ...
     * @version 1.0
     */
    private static class GestureExt {
        ...
        public GestureExt(Context c, OnGestureResult onGestureResult) {
            this.mContext = c;
